  ...
  if (page === 'landing') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-lg border-b border-purple-500/20">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-white">AgentMarket</span>
            </div>
            <button
              onClick={() => {
                if (wallet) {
        ...
        <div className="pt-32 pb-20 px-6">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
              The first marketplace for trading battle-tested AI agent codebases on Base chain. 
              Skip months of development and launch with proven solutions.
            </p>
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-lg rounded-xl font-semibold hover:scale-105 transition-transform shadow-xl shadow-purple-500/50"
              >
                Explore Marketplace
              </button>
              <button
                ...
                className="px-8 py-4 bg-slate-800 text-white text-lg rounded-xl font-semibold hover:bg-slate-700 transition-colors border border-purple-500/30"
              >
                List Your Agent
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-800/50 backdrop-blur p-8 rounded-2xl border border-purple-500/20 hover:border-purple-500/50 transition-colors">
              ...
              <p className="text-gray-400">
                Smart contract verification ensures sellers truly own the AI agents they're listing. GitHub integration for additional proof.
              </p>
            </div>
        ...
        {/* Stats Section */}
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur rounded-3xl p-12 border border-purple-500/30">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-4xl font-bold text-white mb-2">150+</div>
                <div className="text-gray-400">AI Agents Listed</div>
              </div>
              <div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div>
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-white">Your Listed Agents</h3>
              <button
                onClick={() => setPage('list')}
                className="px-4 py-2 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 transition-colors flex items-center gap-2"
              >
            ...
            {userAgents.length > 0 ? (
              <div className="space-y-4">
                {userAgents.map(agent => (
                  <div key={agent.id} className="bg-slate-800 rounded-lg border border-slate-700 p-6 hover:border-purple-500 transition-colors">
              ...
              <div className="bg-slate-800 rounded-lg border border-slate-700 p-12 text-center">
                ...
                <button
                  onClick={() => setPage('list')}
                  className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold hover:scale-[1.02] transition-transform inline-flex items-center gap-2"
                >
